...
namespace library_management_system.Migrations
{
    ...
    [Migration("20250906142830_AddReaaltionShipsBetweenUserandLibrian")]
    partial class AddReaaltionShipsBetweenUserandLibrian
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("library_management_system.LibraryCard", b =>
                {
                    b.HasOne("library_management_system.User", "User")
                        .WithOne("LibraryCard")
                        .HasForeignKey("library_management_system.LibraryCard", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
